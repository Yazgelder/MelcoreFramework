using MelcoreFramework.FileStored.OsSystem.Concrete;
...
namespace MelcoreFramework.FileStored.OsSystem.Test
{
    public class FileSystemTest
    {
        private const string dllName = "MelcoreFramework.FileStored.OsSystem.dll";
        ...
        public FileSystemTest()
        {
            ...
            services.AddScoped<IFileSystem, SystemFileStored>();
            var opt = Options.Create(new FileSystemParameter()
            {
                AccessKey = "",
                EndPoint = "",
                SecretKey = "",
                Address = "TestDosyaYeri",
                Bucket = "AnaKlasor",
            });
