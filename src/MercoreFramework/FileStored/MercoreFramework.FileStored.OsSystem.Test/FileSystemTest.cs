using MercoreFramework.FileStored.OsSystem.Concrete;
...
namespace MercoreFramework.FileStored.OsSystem.Test
{
    public class FileSystemTest
    {
        private const string dllName = "MercoreFramework.FileStored.OsSystem.dll";
